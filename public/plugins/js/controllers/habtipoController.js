app.controller('habtipoController', function($scope,$http,$location) {
    ...
    $scope.rec = function(id){
        window.location.href = '/Habitaciones/'+id;
    }
    ...
    $scope.dataEditar = function (data) {
       ...
       $scope.editarHabtipo = function () {
        ...
        $http.put(pre+'admin/habtipo/'+idHabtipo,
    ...
    $scope.eliminar = function (id) {
            ...
            function(){
                ...
                $http.delete( pre+'admin/habtipo/'+id ).then(function successCallback(response) {
                    $scope.habtipos = response.data;
                }, function errorCallback(response) {
    ...
    $scope.buscar = function () {
        ...
        $http.get(pre+'cart/buscarHabitaciones/'+$scope.fechaini+'/'+$scope.fechafin).then(function successCallback(response) {
    ...
    $scope.buscarHab = function () {
        if ($('#fechaini').val() == '' || $('#fechafin').val() == '') {
            ...
            $http.get(pre+'cart/buscarHabitaciones/'+fini+'/'+ffin ).then(function successCallback(response) {
                $scope.getDias();
